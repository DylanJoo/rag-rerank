...
instruction_prompt = "Instruction: Write multiple statements (less than 10) that support the given document below. Each statements should be standalone, understandable and concise. All the statements together should cover the document as much as possible. Every statements should start with the format of square bracket with number (e.g., [1])."
