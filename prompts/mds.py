...
instruction_prompt_c = "Instruction: Write multiple statements (fewer than 5) that are supported by the given document below. Each statements should be clear, self-contained, and offer comprehensive context. Collectively, these statements should cover the main pooints of the document. Each statements should start with the format of number in square brackets (e.g., [1])."
