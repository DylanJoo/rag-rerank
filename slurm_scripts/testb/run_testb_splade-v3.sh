...
python3 crux-splade-v3.py --default_config configs/crux/splade-v3_100-minilm_100.yaml \
    --exp testb-splade-v3_100-vanilla_${max_k}_thres_${threshold} \
    data \
    ...
    augmentation \
        --max_k $max_k > logs/rac_${max_k}_thres_${threshold}/testb-splade-v3_100-vanilla_${max_k}.log

# splade-v3 100 + Pointwise - minilm 100 + Vanilla 10
python3 crux-splade-v3.py --default_config configs/crux/splade-v3_100-minilm_100.yaml \
    --exp testb-splade-v3_100-minilm_100-vanilla_${max_k}_thres_${threshold} \
    data \
        --qrels_file /home/dju/datasets/crux/ranking_${threshold}/testb_qrels_pr.txt  \
        --judgement_file /home/dju/datasets/crux/ranking_${threshold}/testb_oracle-passages_judgements.jsonl \
        --threshold ${threshold} \
    ...
    ${ADD_GENERATION:+generation --max_length ${max_report_length}} \
    augmentation \
        --max_k $max_k > logs/rac_${max_k}_thres_${threshold}/testb-splade-v3_100-minilm_100-vanilla_${max_k}.log
...
python3 crux-splade-v3.py --default_config configs/crux/splade-v3_100-monot5_100.yaml \
    --exp testb-splade-v3_100-monot5_100-vanilla_${max_k}_thres_${threshold} \
    data \
        --qrels_file /home/dju/datasets/crux/ranking_${threshold}/testb_qrels_pr.txt  \
        --judgement_file /home/dju/datasets/crux/ranking_${threshold}/testb_oracle-passages_judgements.jsonl \
        --threshold ${threshold} \
    ...
    ${ADD_GENERATION:+generation --max_length ${max_report_length}} \
    augmentation \
        --max_k $max_k > logs/rac_${max_k}_thres_${threshold}/testb-splade-v3_100-monot5_100-vanilla_${max_k}.log
...
python3 crux-splade-v3.py --default_config configs/crux/splade-v3_100-rankgpt_100.yaml \
    --exp testb-splade-v3_100-rankzephyr_100-vanilla_${max_k}_thres_${threshold} \
    data \
        --qrels_file /home/dju/datasets/crux/ranking_${threshold}/testb_qrels_pr.txt  \
        --judgement_file /home/dju/datasets/crux/ranking_${threshold}/testb_oracle-passages_judgements.jsonl \
        --threshold ${threshold} \
    ...
    ${ADD_GENERATION:+generation --max_length ${max_report_length}} \
    augmentation \
        --max_k $max_k > logs/rac_${max_k}_thres_${threshold}/testb-splade-v3_100-rankzephyr_100-vanilla_${max_k}.log
...
python3 crux-splade-v3.py --default_config configs/crux/splade-v3_100-rankfirst_100.yaml \
    --exp testb-splade-v3_100-rankfirst_100-vanilla_${max_k}_thres_${threshold} \
    data \
        --qrels_file /home/dju/datasets/crux/ranking_${threshold}/testb_qrels_pr.txt  \
        --judgement_file /home/dju/datasets/crux/ranking_${threshold}/testb_oracle-passages_judgements.jsonl \
        --threshold ${threshold} \
    ...
    ${ADD_GENERATION:+generation --max_length ${max_report_length}} \
    augmentation \
        --max_k $max_k > logs/rac_${max_k}_thres_${threshold}/testb-splade-v3_100-rankfirst_100-vanilla_${max_k}.log
...
python3 crux-splade-v3.py --default_config configs/crux/splade-v3_100-setwise_100.yaml \
    --exp testb-splade-v3_100-setwise_100-vanilla_${max_k}_thres_${threshold} \
    data \
        --qrels_file /home/dju/datasets/crux/ranking_${threshold}/testb_qrels_pr.txt  \
        --judgement_file /home/dju/datasets/crux/ranking_${threshold}/testb_oracle-passages_judgements.jsonl \
        --threshold ${threshold} \
    ...
    ${ADD_GENERATION:+generation --max_length ${max_report_length}} \
    augmentation \
        --max_k $max_k > logs/rac_${max_k}_thres_${threshold}/testb-splade-v3_100-setwise_100-vanilla_${max_k}.log
...
python3 crux-splade-v3.py --default_config configs/crux/splade-v3_100-minilm_100-mmr_10.yaml \
    --exp testb-splade-v3_100-minilm_100-mmr_10-vanilla_${max_k}_thres_${threshold} \
    data \
        --qrels_file /home/dju/datasets/crux/ranking_${threshold}/testb_qrels_pr.txt  \
        --judgement_file /home/dju/datasets/crux/ranking_${threshold}/testb_oracle-passages_judgements.jsonl \
        --threshold ${threshold} \
    ...
    ${ADD_GENERATION:+generation --max_length ${max_report_length}} \
    augmentation \
        --max_k $max_k > logs/rac_${max_k}_thres_${threshold}/testb-splade-v3_100-minilm_100-mmr_10-vanilla_${max_k}.log
