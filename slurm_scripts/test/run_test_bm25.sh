...
python3 crux-bm25.py --default_config configs/crux/bm25_100-minilm_100.yaml \
    --exp ${data}-bm25_100-vanilla_${max_k} \
    data \
    ...
    augmentation \
        --max_k $max_k > logs/rac_${max_k}/${data}-bm25_100-vanilla_${max_k}.log

# BM25 100 + Pointwise - minilm 100 + Vanilla 10
python3 crux-bm25.py --default_config configs/crux/bm25_100-minilm_100.yaml \
    --exp ${data}-bm25_100-minilm_100-vanilla_${max_k} \
    data \
        --topic_file /home/dju/datasets/crux/ranking_5/${data}_topics.jsonl \
        --qrels_file /home/dju/datasets/crux/ranking_3/${data}_qrels_pr.txt  \
        --judgement_file /home/dju/datasets/crux/ranking_3/${data}_oracle-passages_judgements.jsonl \
    ...
    ${ADD_GENERATION:+generation --max_length ${max_report_length}} \
    augmentation \
        --max_k $max_k > logs/rac_${max_k}/${data}-bm25_100-minilm_100-vanilla_${max_k}.log 

# BM25 100 + Pointwise - monot5 100 + Vanilla 10
python3 crux-bm25.py --default_config configs/crux/bm25_100-monot5_100.yaml \
    --exp ${data}-bm25_100-monot5_100-vanilla_${max_k} \
    data \
        --topic_file /home/dju/datasets/crux/ranking_5/${data}_topics.jsonl \
        --qrels_file /home/dju/datasets/crux/ranking_3/${data}_qrels_pr.txt  \
        --judgement_file /home/dju/datasets/crux/ranking_3/${data}_oracle-passages_judgements.jsonl \
    ...
    ${ADD_GENERATION:+generation --max_length ${max_report_length}} \
    augmentation \
        --max_k $max_k > logs/rac_${max_k}/${data}-bm25_100-monot5_100-vanilla_${max_k}.log
...
python3 crux-bm25.py --default_config configs/crux/bm25_100-rankgpt_100.yaml \
    --exp ${data}-bm25_100-rankzephyr_100-vanilla_${max_k} \
    data \
        --topic_file /home/dju/datasets/crux/ranking_5/${data}_topics.jsonl \
        --qrels_file /home/dju/datasets/crux/ranking_3/${data}_qrels_pr.txt  \
        --judgement_file /home/dju/datasets/crux/ranking_3/${data}_oracle-passages_judgements.jsonl \
    ...
    ${ADD_GENERATION:+generation --max_length ${max_report_length}} \
    augmentation \
        --max_k $max_k > logs/rac_${max_k}/${data}-bm25_100-rankzephyr_100-vanilla_${max_k}.log 
...
python3 crux-bm25.py --default_config configs/crux/bm25_100-rankfirst_100.yaml \
    --exp ${data}-bm25_100-rankfirst_100-vanilla_${max_k} \
    data \
        --topic_file /home/dju/datasets/crux/ranking_5/${data}_topics.jsonl \
        --qrels_file /home/dju/datasets/crux/ranking_3/${data}_qrels_pr.txt  \
        --judgement_file /home/dju/datasets/crux/ranking_3/${data}_oracle-passages_judgements.jsonl \
...
python3 crux-bm25.py --default_config configs/crux/bm25_100-setwise_100.yaml \
    ...
    ${ADD_GENERATION:+generation --max_length ${max_report_length}} \
    augmentation \
        --max_k $max_k > logs/rac_${max_k}/${data}-bm25_100-setwise_100-vanilla_${max_k}.log
...
python3 crux-bm25.py --default_config configs/crux/bm25_100-minilm_100-mmr_10.yaml \
    --exp ${data}-bm25_100-minilm_100-mmr_10-vanilla_${max_k} \
    data \
        --topic_file /home/dju/datasets/crux/ranking_5/${data}_topics.jsonl \
        --qrels_file /home/dju/datasets/crux/ranking_3/${data}_qrels_pr.txt  \
        --judgement_file /home/dju/datasets/crux/ranking_3/${data}_oracle-passages_judgements.jsonl \
    ...
    ${ADD_GENERATION:+generation --max_length ${max_report_length}} \
    augmentation \
        --max_k $max_k > logs/rac_${max_k}/${data}-bm25_100-minilm_100-mmr_10-vanilla_${max_k}.log
