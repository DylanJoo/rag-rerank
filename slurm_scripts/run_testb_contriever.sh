...
python3 crux-contriever.py --default_config configs/crux/contriever_100-minilm_100.yaml \
    ...
    augmentation \
        --max_k $max_k > logs/rac_${max_k}/testb-contriever_100-vanilla_${max_k}.log
...
python3 crux-contriever.py --default_config configs/crux/contriever_100-minilm_100.yaml \
    ...
    ${ADD_GENERATION:+generation --max_length ${max_report_length}} \
    augmentation \
        --max_k $max_k > logs/rac_${max_k}/testb-contriever_100-minilm_100-vanilla_${max_k}.log
...
python3 crux-contriever.py --default_config configs/crux/contriever_100-monot5_100.yaml \
    ...
    ${ADD_GENERATION:+generation --max_length ${max_report_length}} \
    augmentation \
        --max_k $max_k > logs/rac_${max_k}/testb-contriever_100-monot5_100-vanilla_${max_k}.log
...
python3 crux-contriever.py --default_config configs/crux/contriever_100-rankgpt_100.yaml \
    ...
    ${ADD_GENERATION:+generation --max_length ${max_report_length}} \
    augmentation \
        --max_k $max_k > logs/rac_${max_k}/testb-contriever_100-rankzephyr_100-vanilla_${max_k}.log
...
python3 crux-contriever.py --default_config configs/crux/contriever_100-rankfirst_100.yaml \
    ...
    ${ADD_GENERATION:+generation --max_length ${max_report_length}} \
    augmentation \
        --max_k $max_k > logs/rac_${max_k}/testb-contriever_100-rankfirst_100-vanilla_${max_k}.log
...
python3 crux-contriever.py --default_config configs/crux/contriever_100-setwise_100.yaml \
    ...
    ${ADD_GENERATION:+generation --max_length ${max_report_length}} \
    augmentation \
        --max_k $max_k > logs/rac_${max_k}/testb-contriever_100-setwise_100-vanilla_${max_k}.log
...
python3 crux-contriever.py --default_config configs/crux/contriever_100-minilm_100-mmr_10.yaml \
    ...
    ${ADD_GENERATION:+generation --max_length ${max_report_length}} \
    augmentation \
        --max_k $max_k > logs/rac_${max_k}/testb-contriever_100-minilm_100-mmr_10-vanilla_${max_k}.log
